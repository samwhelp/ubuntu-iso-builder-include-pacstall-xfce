...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-include-pacstall-xfce](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce.git
```


> change dir to `ubuntu-iso-builder-include-pacstall-xfce`

``` sh
cd ubuntu-iso-builder-include-pacstall-xfce
```
